...
for (let i=0; i<extend.length; i++){
    extend[4].addEventListener("click", function() {
        for (let i=0; i<clickextend.length; i++){
...
for (let i=0; i<extend.length; i++){
    extend[5].addEventListener("click", function() {
        for (let i=0; i<clickextend.length; i++){
...
for (let i=0; i<extend.length; i++){
    extend[6].addEventListener("click", function() {
        for (let i=0; i<clickextend.length; i++){
...
for (let i=0; i<extend.length; i++){
    extend[8].addEventListener("click", function() {
        for (let i=0; i<clickextend.length; i++){
